...
console.log(`index of you in ${message} is ${message.indexOf("you")}`);
// Log the index of word "still" in message
console.log(`index of still in ${message} is ${message.indexOf("still")}`);

// Log the index of word "answers" in message
console.log(`index of answer in ${message} is ${message.indexOf("answer")}`);
